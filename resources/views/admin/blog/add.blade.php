        ...
        <div class="col-12">
            <div class="card card-body">
               ...
               <div class="alert alert-success alert-dismissible">
                ...
                <form action="{{route('admin.blog.add')}}" method="post" enctype="multipart/form-data" class="form-horizontal m-t-30">
                    @csrf 
                    ...
                    <div class="form-group">
                        <label>Content</label>
                        <textarea class="ckeditor" id="editor1" name="content" class="form-control" rows="5">{{old('content')}}</textarea>
                    </div>
