...
<body>
	<header id="header"><!--header-->
		@if (Auth::check())
			<div id="user_id" user_id="{{Auth::id()}}"></div>
					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="{{route('frontend.account')}}"><i class="fa fa-user" user_id="{{Auth::id()}}"></i> Account</a></li>
								...
								<li><a href="{{route('frontend.signup')}}"><i class="fa fa-lock"></i> Register</a></li>
								@endif
							</ul>
						</div>
					</div>
